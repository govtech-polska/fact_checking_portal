    ...
    <>
      ...
      <Layout>
        <div className={`about-project ${isEn ? 'en' : ''}`}>
          ...
          <section className="s3" id="jatodziala">
            <div className="container-fluid">
              <div className="row no-gutters">
                <div className="col-lg-6">
                  <div className="imageWrapper">
                ...
                <div className="col-lg-6">
                  <div className="textWrapper">
                    ...
                    <div className="collapse" id="collapseTwo">
                      <h3 className="subtitle">{t('about:section2.collapsed.title')}</h3>
                      <ol>
                    ...
                    <div className="dropdown">
                      <button
                        ...
                        aria-expanded="false"
                      >
                        {t('about:section2.installExtBtn')}
                      </button>
          ...
          <section className="s7" id="dolacz">
            <div className="container-fluid">
              <div className="row no-gutters">
                <div className="col-lg-6">
                  <div className="imageWrapper">
                    <img src="/images/image6.png" alt="" />
                    <div className="author">Luca Bravo / Unsplash</div>
                  </div>
                </div>
                <div className="col-lg-6">
                  <div className="textWrapper">
                    <h2 className="section">{t('about:section6.title')}</h2>
                    <p className="title">{t('about:section6.subtitle')}</p>
                    <p>{t('about:section6.description')}</p>
                    <a
                      target="_blank"
                      rel="noopener noreferrer"
                      className="button"
                      href="https://form.govtech.gov.pl/ankieta/511625/zwalczwirusakodem-dolacz-do-zespolu-dev-aplikacji-do-walki-z-dezinformacja.html
"
                    >
                      {t('about:section6.applyBtn')}
                    </a>
                  </div>
                </div>
              </div>
